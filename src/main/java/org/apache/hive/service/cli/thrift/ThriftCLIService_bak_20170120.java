 ...
 *
 */
public abstract class ThriftCLIService_bak_20170120 extends AbstractService implements TCLIService.Iface, Runnable {

  public static final Log LOG = LogFactory.getLog(ThriftCLIService_bak_20170120.class.getName());
  ...
  public TOpenSessionResp OpenSession(TOpenSessionReq req) throws TException {
    //System.out.println("research log : call " + this.getClass().getMethods() );
      printM();
  ...
  public TExecuteStatementResp ExecuteStatement(TExecuteStatementReq req) throws TException {
    printM();
    System.out.println(req.getStatement());
    req.setStatement("show tables from bill");
