 ...
 *
 */
public abstract class ThriftCLIService_bak_20170116 extends AbstractService implements TCLIService.Iface, Runnable {

  public static final Log LOG = LogFactory.getLog(ThriftCLIService_bak_20170116.class.getName());
