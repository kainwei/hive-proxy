 ...
 *
 */
public abstract class ThriftCLIService_bak extends AbstractService implements TCLIService.Iface, Runnable {

  public static final Log LOG = LogFactory.getLog(ThriftCLIService_bak.class.getName());
