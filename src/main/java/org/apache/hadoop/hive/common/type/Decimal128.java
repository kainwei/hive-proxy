 ...
 * </p>
 * <p>
 * This class is similar to {@link BigDecimal}, but a few things
 * differ to conform to the SQL Numeric semantics.
 * </p>
 * <p>
 * Scale of this object is specified by the user, not automatically determined
 * like {@link BigDecimal}. This means that underflow is possible
 * depending on the scale. {@link BigDecimal} controls rounding
...
public final class Decimal128 extends Number implements Comparable<Decimal128> {
   ...
   *          {@link BigDecimal#pow(int)}, this can receive a
